...
Compress-Archive -Path $items -DestinationPath 'antigravity-v1.3.3.zip' -Force
Write-Host "ZIP antigravity-v1.3.3.zip gerado com sucesso!" -ForegroundColor Green
